...
import { h as $e } from './B5ZXLP5g.js';
import { p as O, r as M, l as me, s as Pe } from './BPV7WAZE.js';
import { B as ke, H as S, P as v, b as m, U as k, L as u, a as xe } from './DEl8EeN2.js';
import { s as E } from './DY748rXZ.js';
import { a as L, c as D } from './DrzAit6R.js';
var ye = d('<h1><!></h1>');
function be(b, f) {
	I(f, !0);
	let w = O(f, 'class', 3, void 0),
		T = M(f, ['$$slots', '$$events', '$$legacy', 'class', 'children']);
	var _ = ye();
	L(_, (y) => ({ class: y, ...T }), [() => D('mt-2 scroll-m-20 text-4xl font-bold', w())]);
	var x = H(_);
	(E(x, () => f.children), B(_), s(b, _), A());
}
var we = d('<h4><!></h4>');
function C(b, f) {
	I(f, !0);
...
const ve = {
	...
	{ title: Bs, date: zs, published: Is, author: As, summary: Os, categories: Ms } = ve;
var He = d('<strong>Back Button</strong>: Quick navigation to the blog index', 1),
	...
	gs = d('<!> <!> <!>', 1),
	fs = d('<strong>Reading Analytics</strong>: Track engagement metrics', 1),
...
function Es(b, f) {
	const w = me(f, ['children', '$$slots', '$$events', '$$legacy']);
	ke(
		b,
		Pe(
			() => w,
