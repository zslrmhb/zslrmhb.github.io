...
function Xr(e, o, r, t, s, a, n, d, c) {
	...
	if (u !== null || b !== void 0) {
		for (var O = b === void 0 ? [] : qe(b); u !== null; )
			((u.e.f & me) === 0 && O.push(u), (u = u.next));
		var P = O.length;
		if (P > 0) {
			var D = (n & Ye) !== 0 && C === 0 ? s : null;
			if (m) {
				for (g = 0; g < P; g += 1) O[g].a?.measure();
				for (g = 0; g < P; g += 1) O[g].a?.fix();
			}
			Kr(r, O, D);
		}
	}
...
function Je(e) {
	...
	if (typeof e == 'string' || typeof e == 'number') t += e;
		...
		if (Array.isArray(e)) {
			var s = e.length;
			for (o = 0; o < s; o++) e[o] && (r = Je(e[o])) && (t && (t += ' '), (t += r));
		} else for (r in e) e[r] && (t && (t += ' '), (t += r));
	return t;
}
function er() {
	for (var e, o, r = 0, t = '', s = arguments.length; r < s; r++)
		(e = arguments[r]) && (o = Je(e)) && (t && (t += ' '), (t += o));
	return t;
}
function Qr(e) {
		...
		for (var s in r)
			if (r[s]) t = t ? t + ' ' + s : s;
				...
				for (var a = s.length, n = 0; (n = t.indexOf(s, n)) >= 0; ) {
					var d = n + a;
					(n === 0 || Ge.includes(t[n - 1])) && (d === t.length || Ge.includes(t[d]))
...
function et(e, o) {
	if (o) {
		...
		return (t && (r += Oe(t)), s && (r += Oe(s, !0)), (r = r.trim()), r === '' ? null : r);
	}
...
function at(e, o, r, t, s = !1) {
	...
	(r.class ? (r.class = Qr(r.class)) : r[Z] && (r.class = null), r[Q] && (r.style ??= null));
	var A = sr(e);
	for (const w in r) {
		let k = r[w];
		if (v && w === 'value' && k == null) {
...
export { Bt as a, rt as b, Ut as c, tt as d, jt as e, Ht as f, Qr as g, er as h, Ft as i, $e as s };
