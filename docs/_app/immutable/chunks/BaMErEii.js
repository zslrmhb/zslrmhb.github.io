import { k as f, j as s, s as l, ad as a, C as m, aj as h } from './7lH0bu5J.js';
import { i as o, b as w } from './DHBKuhVu.js';
class O {
	#e;
	#t;
	constructor(t) {
...
const d = 1,
	...
	E = 11;
function i(e) {
	return o(e) && e.nodeType === d && typeof e.nodeName == 'string';
}
function u(e) {
	return o(e) && e.nodeType === g;
}
function y(e) {
...
function D(e) {
	return u(e) ? e : y(e) ? e.document : (e?.ownerDocument ?? document);
}
function T(e) {
	return c(e)
		? T(e.host)
...
class A {
	...
	getDocument = () => D(this.root);
	getWindow = () => this.getDocument().defaultView ?? window;
	getActiveElement = () => x(this.root);
...
export { O as C, A as D, D as a, p as c, T as g };
