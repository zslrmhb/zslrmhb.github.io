...
import { s as we } from '../chunks/Dm31YeMj.js';
import '../chunks/B5_alTbJ.js';
import { P as V, R as W, T as X, B as oe, a as Z, M as xe } from '../chunks/D5WLMpeD.js';
import { S as $e } from '../chunks/z5ce2c5v.js';
import { o as _e, a as ke } from '../chunks/C5HLncaA.js';
import { i as I } from '../chunks/CwxTF5KJ.js';
import { b as ee, e as ye, d as Ce, s as te } from '../chunks/0UGGdwXT.js';
import { b as Ee } from '../chunks/CyFIKMQc.js';
import { i as Be } from '../chunks/Cm3kWbeN.js';
var Le = re(
...
var Ne = re(
	...
	Se = (k, u, o) => u(t(o).id),
	qe = c('<li><button type="button"><span class="line-clamp-2"> </span></button></li>'),
	Ae = c('<nav class="max-h-[calc(100dvh-6rem)] overflow-y-auto py-2"><ul></ul></nav>'),
	De = c('<p class="px-4 py-5 text-sm text-muted-foreground">No section headings found.</p>'),
	Oe = c(
		...
		q(
			...
			a
				...
				.map((r) => {
					...
					return { id: w(s, f, e), text: f, level: $, element: s };
				})
		);
	}
	function i() {
				...
				f = m(s);
			{
				...
				oe(f, {
					...
					children: (T, Y) => {
						var S = Ne();
						(U(() =>
							ee(S, 0, `h-4 w-4 transition-transform duration-200 ${t(o) ? 'rotate-90' : ''}`)
						),
							n(T, S));
					},
					$$slots: { default: !0 }
