...
import { f as F, s as E, e as J } from '../chunks/0UGGdwXT.js';
import { c as K } from '../chunks/CyFIKMQc.js';
import { B as Q } from '../chunks/TexbRBND.js';
import { S as W } from '../chunks/z5ce2c5v.js';
const X = (n, t, l) => {
	const i = n[t];
	return i
		? typeof i == 'function'
...
async function Z({ params: n }) {
	try {
		...
		Y(404, `Could not find ${n.slug}`);
	}
}
const vt = Object.freeze(
	Object.defineProperty({ __proto__: null, load: Z }, Symbol.toStringTag, { value: 'Module' })
);
var $ = p('<meta name="description"/> <meta property="og:description"/>', 1),
	tt = p('<meta property="og:type" content="article"/> <meta property="og:title"/> <!>', 1),
	at = p('<p class="max-w-2xl text-base leading-7 text-muted-foreground md:text-lg"> </p>'),
	et = p('<div class="tags mb-8 flex flex-wrap gap-2"></div>'),
	rt = p(
...
function pt(n, t) {
	...
	V((a) => {
		...
		(u(() => {
			((G.title = t.data.meta.title), E(m, 'content', t.data.meta.title));
		}),
			d(a, e));
	});
	var i = s(l),
	...
	var q = r(x, 2);
	{
		var B = (a) => {
			var e = at(),
				m = s(e, !0);
			(o(e), u(() => v(m, t.data.meta.summary)), d(a, e));
		};
		w(q, (a) => {
	...
	(K(
		...
		u(
			...
			[() => F(t.data.meta.date, 'long')]
		),
		d(n, l),
		C());
}
export { pt as component, vt as universal };
